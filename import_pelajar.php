              ...
              <center>
                  ...
                  <tr>
                    <td>
                      ...
                      <table class="inner-table" width="100%" align="center" border="0" >
                        <tr>
                          <td>
                            <label class='font'>Kemudahan untuk dafter nama pelajar secara berkelompok</label><br>
                ...
                <tr>
                  <td>
                    ...
                    <table class="inner-table" width="70%" align="center" border="0">
                      <tr class='font'>
                        <td>Nombor IC Pelajar</td>
                        <td>Password</td>
                        <td>Nama Pelajar</td>
                        <td>Jantina</td>
                      </tr>
