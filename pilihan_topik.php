...
<main>
	<center>
<table width="70%" border="0" align="center" style="background-color: #DCD9CD; border: 25px solid #DCD9CD; border-radius: 25px; width: fixed; align: center;">
<tr>
...
<td width="5%"><b style="font-family: poppins; font-size: 15px;">Tindakan</b></td>
                ...
                while ($info1=mysqli_fetch_array($data1))
                {
                    ...
                    <td>
                        ...
                        <?php echo $infoTopik['idtopik']; ?>&jenis=<?php echo $info1['jenis']; ?>"*>
