...
<label>Pilihan 4: </label><input type="text" name="pilih4" size="50" style=""/><br>
<label>Pilihan Jawapan [1-4] :</label><input type="text" name="jawapan_betul" size="5" style="width: 5%; text-align: center;" required />
</p>
</td></tr>
</table>
</td>
